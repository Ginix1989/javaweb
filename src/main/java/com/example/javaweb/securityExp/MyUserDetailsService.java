...
//                    return userInfo;
                    //假设返回的用户信息如下;
                    UserInfo userInfo = new UserInfo(parentInfo, null, null, null, "ROLE_PARENT", true, true, true, true);
                    return userInfo;
                } else {
                    return null;
                }
...
//                    return userInfo;
                    //假设返回的用户信息如下;
                    UserInfo userInfo = new UserInfo(null, null, null, villageAdminStaff, "ROLE_ADMIN", true, true, true, true);
                    return userInfo;
                } else {
                    return null;
                }
...
//                    return userInfo;
                    UserInfo userInfo = new UserInfo(null, null, villageStaff, null, "ROLE_STAFF", true, true, true, true);
                    return userInfo;
                } else {
                    return null;
                }
